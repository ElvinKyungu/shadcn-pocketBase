<template>
  <div class="
    flex justify-center fixed top-1/2 left-1/2 z-50 h-screen w-full transform -translate-x-1/2 
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
            ...
            <button 
              ...
              type="button" 
              class="
                ms-3 text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 
...
const closeModal = () => {
  // Émettre l'événement personnalisé "close-modal" avec le signal de fermeture
  emit("close-modal");
};
const addTask = ()=>{
